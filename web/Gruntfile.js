module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy:{
      ...
      swf: {
        src: '<%= appConfig.path %>bower_components/ng-file-upload/FileAPI.flash.swf',
        dest: '<%= appConfig.distAssets %>FileAPI.flash.swf'
      },
      js: {
        src: '<%= appConfig.path %>bower_components/ng-file-upload/FileAPI.min.js',
        dest: '<%= appConfig.distAssets %>FileAPI.min.js'
      },
      pages: {
        expand: true,
        cwd: 'app/pages',
